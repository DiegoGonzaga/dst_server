...
def atualiza_servidor():
    ...
    if(opcao):
        os.system("\"c:/Program Files (x86)/Steam/steamcmd/steamcmd.exe\" +login anonymous +app_update 343050 validate +quit")
...
def inicializa_servidor(servidor,shard):
    ...
    complemento= "start \""+ servidor +": "+shard+"\" dontstarve_dedicated_server_nullrenderer -console -cluster "+ servidor +" -shard "+shard
